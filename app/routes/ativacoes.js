...
module.exports = function(app) {
    ...
    app.get('/ativacoes', function (request, response) {
        var connection = app.infra.connectionFactory(function (err,conect) {
        var ativacoes = new app.infra.Ativacoes(conect);
            ativacoes.lista(function (err,recordset) {
    ...
    app.get('/pontosLTM', function (request, response) {
        var connection = app.infra.connectionFactory(function (err, resultado) {
            resultado.query('use Turbine5_dev;' +
